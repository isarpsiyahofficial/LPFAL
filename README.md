...
4. [`TODO.md`](./TODO.md) — bağımlılıklara göre sıralanmış ana faz listesi; Rüya/Compliance uygulamasında yukarıdaki iki yeni normatif dosya ayrıca zorunludur.
5. [`V1_RELEASE_GATES.md`](./V1_RELEASE_GATES.md) — bloklayıcı release şartları; `COMPLIANCE_BY_DESIGN.md` ek gate'leri de final için zorunludur.
6. [`MONETIZATION_V1.md`](./MONETIZATION_V1.md) — Rewarded, 90 saniye timed interstitial, banner ve Premium reklam kuralları.
7. [`BILLING_RESTORE_SPEC.md`](./BILLING_RESTORE_SPEC.md) — Google Play satın alma/restore davranışı.
8. [`PRODUCT_MODEL_V1.md`](./PRODUCT_MODEL_V1.md) — **Premium ürün modeli ve isim standardında ana kaynak**.
9. [`FUNCTIONAL_UI_GATES.md`](./FUNCTIONAL_UI_GATES.md) — mockup'ların gerçek Flutter UI'a dönüşüm kabul şartları.
10. [`UI_ASSET_MANIFEST.md`](./UI_ASSET_MANIFEST.md) — repo içindeki üretilmiş UI görsellerinin dosya/SHA envanteri ve görsel-copy gate'i.
