...
Aşağıdaki **7 JPG** repo içinde mevcut:
...
- Toplam repo içinde doğrulanan JPG: **18**

Bu nedenle üretilmiş UI görsellerinin yalnız sohbet içinde kalmadığı, repo içinde commitli dosyalar olarak bulunduğu doğrulanmıştır.

## 4. Premium copy kuralı
...
**Bu manifest görsel dosya varlığı ve Premium görsel-copy QA için zorunlu kontroldür.**